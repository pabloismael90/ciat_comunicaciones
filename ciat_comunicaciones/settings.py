# Django settings for ciat_comunicaciones project.
...
SECRET_KEY = '0bwp$ia3r93zoj+nx+@%-va$8g3ije(xn=68vjtyrf3iihnn_t'
...
ROOT_URLCONF = 'ciat_comunicaciones.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ciat_comunicaciones.wsgi.application'
